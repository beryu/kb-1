...
| **電源回路部品**                                                              |      | 0603/0805部品とXCL103D333CR-GはリフローまたはPCBAでの実装を推奨します                                                                                       |
| 3.3V昇圧DCDCコンバーターモジュール(AE-XCL103-3V3)                             | 1    | 右手側に使用。[秋月電子](https://akizukidenshi.com/catalog/g/g116116/)                                                                                       |
| 3.3V昇圧DCDCコンバーターIC(XCL103D333CR-G、CL-2025-02)                        | 1    | 左手側に使用。[JLCPCB Parts](https://jlcpcb.com/partdetail/TorexSemicon-XCL103D333CRG/C7158885)など                                                        |
| 理想ダイオード機能搭載ロードスイッチ(XC8111AA01MR-G、SOT-23-5)               | 2    | 左右各1。[秋月電子](https://akizukidenshi.com/catalog/g/g130281/)                                                                                            |
| チップ積層セラミックコンデンサー(10µF、X7R、0805)                            | 2    | 左右各1                                                                                                                                                      |
| チップ積層セラミックコンデンサー(10µF、X7R、0603)                            | 1    | 左手側に使用                                                                                                                                                 |
